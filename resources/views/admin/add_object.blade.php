                ...
                <div class="col">
                    <div class="card-body">
                        <div class=" d-flex justify-content-center mb-5">
                            <form action="{{route('AddObject')}}" class="w-50 mt-5" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('post')
                                <div class="mb-3">
                                    <label for="title" class="form-label" style="font-weight:bold">Название объекта</label>
                                    <input  type="text" class="form-control inp @error('title') is-invalid @enderror" id="title" name="title" >
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control inp @error('address') is-invalid @enderror" id="address" name="address">
                                    <div id="ValidationServerUsernameFeedback" class="is-invalid text-danger">
                                        @error('address')
                                        {{$message}}
                                        @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input class="form-control inp @error('square') is-invalid @enderror" name="square" id="square" >
                                    <div id="ValidationServerUsernameFeedback" class="is-invalid text-danger">
                                        @error('square')
                                        {{$message}}
                                        @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="month"  class="form-control inp @error('year') is-invalid @enderror" id="year" name="year">
                                    <div id="ValidationServerUsernameFeedback" class="is-invalid text-danger">
                                        @error('year')
                                        {{$message}}
                                        @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea type="text" class="form-control inp @error('description') is-invalid @enderror" id="description" name="description" cols="30" rows="5"></textarea>
                                    <div id="ValidationServerUsernameFeedback" class="is-invalid text-danger">
                                        @error('description')
                                        {{$message}}
                                        @enderror
