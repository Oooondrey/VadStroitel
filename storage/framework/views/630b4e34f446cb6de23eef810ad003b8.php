        ...
        const Admin={
            ...
            methods:{
                async Admin(){
                    ...
                    const response=await fetch('<?php echo e(route('AdminLogin')); ?>',{
                        method:'post',
                        headers:{
...
<?php echo $__env->make('layout.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\OSPanel\domains\VADSTROITEL\resources\views/admin/adminauthpage.blade.php ENDPATH**/ ?>